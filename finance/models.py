...
class Payment(models.Model):
    ...
    # Audit trail for manually-entered/edited payments — see the identical
    # fields on admissions.ApplicationPayment for the full reasoning.
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_fee_payments',
    )
    updated_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='updated_fee_payments',
    )
